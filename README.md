...
### Software Engineer · Generative AI · Cloud & Distributed Systems
...
Engenheiro de Software focado em **arquitetura moderna, sistemas distribuídos e IA generativa aplicada**, atuando com:

* **Backends escaláveis em .NET & Java**
* **LLMs, RAG e pipelines de dados complexos**
* **Cloud, containers e alta disponibilidade**
* **Clean Architecture, DDD e código sustentável**
...
* ASP.NET Core · .NET 8 · Java Spring Boot
* DDD · CQRS · BFF · Microservices
* Dapper · EF Core · SQL Server · PostgreSQL
* Kafka · RabbitMQ · RESTful APIs
...
* RAG · Fine-tuning · Tokenizers
* HuggingFace · OpenAI API · FAISS
* Databricks · RAGAS · ETL
...
* Arquitetura Hexagonal · Testes Automatizados
...
*Arquitetura limpa, IA aplicada e engenharia de software de alto nível para resolver problemas reais.*
